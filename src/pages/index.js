...
const IndexPage = () => {
  ...
  return (
    <Layout seo={data.strapiHomepage.seo} helloBar={1}>
      <div className="container md:flex px-6 pt-4 mx-auto lg:h-128 mb-12 md:mb-32">
        <div className="flex flex-col items-center w-full lg:flex-row lg:w-1/2">
          ...
          <div className="grid grid-cols-4 mt-8 mb-10 w-64 mx-auto">
            ...
            <a href="#events" className="hidden md:block px-5 py-5 text-sm bg-pink-600 text-white no-underline border border-pink-600 font-bold rounded-lg hover:text-gray-300 hover:no-underline text-sm">SEE UPCOMING SHOWS</a>
            <div className="mt-3 grid grid-cols-2 gap-3">
            <a href="https://www.amazon.com/shop/trixietuzzini" target="_blank" className="hidden md:inline-block px-5 py-3 text-sm text-white no-underline border border-white font-bold rounded-lg hover:text-gray-300 hover:no-underline text-sm">
               <img src="/amazon.svg" className="w-5 inline mr-3"/>
              MY AMAZON STORE
            </a>
            <a href="https://www.cameo.com/trixietuzzini" target="_blank" className="hidden md:inline-block px-5 py-3 text-sm text-white no-underline border border-white font-bold rounded-lg hover:text-gray-300 hover:no-underline text-sm">
      ...
      <a href="#events" className="block text-center mb-5 px-5 py-3 text-sm text-white no-underline border border-pink-600 bg-pink-600 font-bold rounded-lg hover:text-gray-300 hover:no-underline text-sm">
